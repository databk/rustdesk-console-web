export default {
  ...
  'pages.nexus.bindSuccess': 'Nexus account bound successfully',
  'pages.nexus.bindFailed': 'Failed to bind Nexus account',
  'pages.nexus.createLoginFailed': 'Failed to create login session',
  'pages.nexus.unbindConfirm': 'Unbind Nexus Account',
  'pages.nexus.unbindConfirmContent': 'Are you sure you want to unbind your Nexus account? You will need to re-bind to generate custom clients.',
  'pages.nexus.unbindSuccess': 'Nexus account unbound',
  'pages.nexus.unbindFailed': 'Failed to unbind Nexus account',
  'pages.nexus.tokenExpired': 'Nexus Token Expired',
  'pages.nexus.tokenExpiredDesc': 'Your Nexus token for {username} has expired. Please re-bind your account.',
  'pages.nexus.rebind': 'Re-bind Nexus Account',
  'pages.nexus.bindTitle': 'Bind Nexus Account',
  ...
  'pages.nexus.generateTitle': 'Generate Custom Client',
  'pages.nexus.generateNotice': 'You need to Star, Fork or Watch the databk/rustdesk-console repository on GitHub before generating. Each user is limited to 15 builds per month.',
  ...
  'pages.nexus.stepBind': 'Bind Nexus',
  'pages.nexus.stepBuild': 'Build Client',
  'pages.nexus.stepStatus': 'Build Status',
