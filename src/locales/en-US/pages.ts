export default {
  ...
  'pages.devices.connect': 'Connect',
  'pages.devices.connectRemoteDesktop': 'Remote Desktop',
  'pages.devices.connectFileTransfer': 'File Transfer',
  'pages.devices.connectViewCamera': 'View Camera',
  'pages.devices.connectPortForward': 'Port Forward',
  ...
  'pages.audits.result.allowed': 'Allowed',
  'pages.audits.result.denied': 'Denied',
  'pages.audits.target': 'Target',
  'pages.audits.beforeState': 'Before state',
  'pages.audits.afterState': 'After state',
  ...
  'pages.audits.alarmType.idWhitelist': 'ID Not in Whitelist',
  'pages.audits.primaryAuth': 'Primary Auth',
  'pages.audits.primaryAuth.none': 'None',
  'pages.audits.primaryAuth.click': 'Click',
  'pages.audits.primaryAuth.temporaryPassword': 'Temporary Password',
  'pages.audits.primaryAuth.permanentPassword': 'Permanent Password',
  'pages.audits.primaryAuth.switchSides': 'Switch Sides',
  'pages.audits.twoFactor': 'Two-Factor Auth',
  'pages.audits.twoFactor.none': 'None',
  'pages.audits.twoFactor.totp': 'TOTP',
  'pages.audits.twoFactor.trustedDevice': 'Trusted Device',
  ...
  'pages.users.resetPasswordTooltip': 'Leave blank to keep current password',
  'pages.users.confirmPassword': 'Confirm Password',
  'pages.users.passwordMismatch': 'Passwords do not match',
  'pages.users.passwordTooShort': 'Password must be at least 6 characters',
  ...
  'pages.dashboard.successCount': 'Success',
  'pages.dashboard.failureCount': 'Failed',
  'pages.dashboard.todayTransfers': 'Today Transfers',
  ...
  'pages.dashboard.alarmTrend': 'Alarms',
  'pages.dashboard.resourceCounts': 'Resource Counts',
  'pages.dashboard.addressBooks': 'Address Books',
  'pages.dashboard.groups': 'Groups',
  'pages.dashboard.roles': 'Roles',
  'pages.dashboard.strategies': 'Strategies',
  ...
  'pages.dashboard.connectionTrend': 'Connections',
  'pages.dashboard.newUsersTrend': 'New Users',
  ...
  'pages.oidcProviders.clearIcon': 'Clear',
  'pages.oidcProviders.svgTooLarge': 'SVG file too large (max 100KB)',
  'pages.oidcProviders.invalidSvg': 'Invalid SVG content',
