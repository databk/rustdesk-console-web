export default {
  ...
  'pages.user.center.tab.avatar': 'Avatar',
  'pages.user.center.tab.security': 'Security',
  'pages.user.center.basicInfo.title': 'Basic Information',
  ...
  'pages.user.center.avatar.title': 'Avatar Settings',
  ...
  'pages.user.center.security.2faAction': 'Action',
