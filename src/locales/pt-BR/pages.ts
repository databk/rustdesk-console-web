export default {
  ...
  'pages.devices.connect': 'Conectar',
  'pages.devices.connectRemoteDesktop': 'Área de Trabalho Remota',
  'pages.devices.connectFileTransfer': 'Transferência de Arquivos',
  'pages.devices.connectViewCamera': 'Ver Câmera',
  'pages.devices.connectPortForward': 'Encaminhamento de Porta',
  ...
  'pages.audits.result.allowed': 'Permitido',
  'pages.audits.result.denied': 'Negado',
  'pages.audits.target': 'Alvo',
  'pages.audits.beforeState': 'Estado anterior',
  'pages.audits.afterState': 'Estado posterior',
  ...
  'pages.audits.alarmType.sessionScopeViolation':
    'Violação de Permissão de Escopo de Sessão',
  'pages.audits.alarmType.idWhitelist': 'ID Não Está na Lista Branca',
  'pages.audits.primaryAuth': 'Autenticação Primária',
  'pages.audits.primaryAuth.none': 'Nenhum',
  'pages.audits.primaryAuth.click': 'Clique',
  'pages.audits.primaryAuth.temporaryPassword': 'Senha Temporária',
  'pages.audits.primaryAuth.permanentPassword': 'Senha Permanente',
  'pages.audits.primaryAuth.switchSides': 'Trocar Lados',
  'pages.audits.twoFactor': 'Autenticação de Dois Fatores',
  'pages.audits.twoFactor.none': 'Nenhum',
  'pages.audits.twoFactor.totp': 'TOTP',
  'pages.audits.twoFactor.trustedDevice': 'Dispositivo Confiável',
  ...
  'pages.settings.generalSection.security': 'Segurança e Manutenção',
  'pages.settings.generalSection.jwtExpiryDays':
    'Expiração do Token JWT (Dias)',
  'pages.settings.generalSection.jwtExpiryDaysExtra':
    'Número de dias antes que os tokens de usuários expirem. Deve ser pelo menos 1.',
  ...
  'pages.settings.generalSection.auditRetentionDaysExtra':
    'Número de dias para manter os logs de auditoria antes da limpeza automática. Defina como 0 para desativar.',
  ...
  'pages.dashboard.totalUsers': 'Usuários',
  'pages.dashboard.adminUsers': 'Admin',
  'pages.dashboard.normalUsers': 'Normal',
  'pages.dashboard.totalDevices': 'Dispositivos',
  'pages.dashboard.onlineDevices': 'Online',
  'pages.dashboard.offlineDevices': 'Offline',
  'pages.dashboard.todayConnections': 'Conexões',
  'pages.dashboard.successCount': 'Sucesso',
  'pages.dashboard.failureCount': 'Falha',
  'pages.dashboard.todayTransfers': 'Transferências',
  'pages.dashboard.uploadCount': 'Upload',
  'pages.dashboard.downloadCount': 'Download',
  'pages.dashboard.systemStatus': 'Status do Sistema',
  'pages.dashboard.uptime': 'Tempo de Atividade',
  'pages.dashboard.trendData': 'Tendências',
  'pages.dashboard.alarmTrend': 'Alarmes',
  'pages.dashboard.resourceCounts': 'Recursos',
  'pages.dashboard.addressBooks': 'Catálogos de Endereços',
  'pages.dashboard.groups': 'Grupos',
  'pages.dashboard.roles': 'Funções',
  'pages.dashboard.strategies': 'Estratégias',
  ...
  'pages.dashboard.connectionTrend': 'Conexões',
  'pages.dashboard.newUsersTrend': 'Novos Usuários',
