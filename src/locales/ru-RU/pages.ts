export default {
  ...
  'pages.devices.connect': 'Подключить',
  'pages.devices.connectRemoteDesktop': 'Удалённый рабочий стол',
  'pages.devices.connectFileTransfer': 'Передача файлов',
  'pages.devices.connectViewCamera': 'Просмотр камеры',
  'pages.devices.connectPortForward': 'Перенаправление портов',
  'pages.devices.connectRdp': 'RDP',
  'pages.devices.connectTerminal': 'Терминал',
  'pages.devices.connectTerminalAdmin': 'Терминал (Админ)',
  ...
  'pages.audits.result.allowed': 'Разрешено',
  'pages.audits.result.denied': 'Отклонено',
  'pages.audits.target': 'Цель',
  'pages.audits.beforeState': 'Состояние до',
  'pages.audits.afterState': 'Состояние после',
  ...
  'pages.audits.alarmType.sessionScopeViolation':
    'Нарушение разрешений в области сеанса',
  'pages.audits.alarmType.idWhitelist': 'ID не в белом списке',
  'pages.audits.primaryAuth': 'Основная аутентификация',
  'pages.audits.primaryAuth.none': 'Нет',
  'pages.audits.primaryAuth.click': 'Клик',
  'pages.audits.primaryAuth.temporaryPassword': 'Временный пароль',
  'pages.audits.primaryAuth.permanentPassword': 'Постоянный пароль',
  'pages.audits.primaryAuth.switchSides': 'Смена сторон',
  'pages.audits.twoFactor': 'Двухфакторная аутентификация',
  'pages.audits.twoFactor.none': 'Нет',
  'pages.audits.twoFactor.totp': 'TOTP',
  'pages.audits.twoFactor.trustedDevice': 'Доверенное устройство',
  ...
  'pages.dashboard.totalUsers': 'Пользователи',
  'pages.dashboard.adminUsers': 'Админ',
  'pages.dashboard.normalUsers': 'Обычные',
  'pages.dashboard.totalDevices': 'Устройства',
  'pages.dashboard.onlineDevices': 'Онлайн',
  'pages.dashboard.offlineDevices': 'Офлайн',
  'pages.dashboard.todayConnections': 'Подключения',
  'pages.dashboard.successCount': 'Успех',
  'pages.dashboard.failureCount': 'Ошибка',
  'pages.dashboard.todayTransfers': 'Передачи',
  'pages.dashboard.uploadCount': 'Загрузка',
  'pages.dashboard.downloadCount': 'Скачивание',
  'pages.dashboard.systemStatus': 'Статус системы',
  'pages.dashboard.uptime': 'Время работы',
  'pages.dashboard.trendData': 'Тенденции',
  'pages.dashboard.alarmTrend': 'Оповещения',
  'pages.dashboard.resourceCounts': 'Ресурсы',
  'pages.dashboard.addressBooks': 'Адресные книги',
  'pages.dashboard.groups': 'Группы',
  'pages.dashboard.roles': 'Роли',
  'pages.dashboard.strategies': 'Стратегии',
  ...
  'pages.common.id': 'ID',
  'pages.dashboard.day': 'д',
  'pages.dashboard.hour': 'ч',
  'pages.dashboard.min': 'мин',
  'pages.dashboard.cpu': 'ЦП',
  'pages.dashboard.memory': 'Память',
  'pages.dashboard.disk': 'Диск',
  'pages.dashboard.connectionTrend': 'Подключения',
  'pages.dashboard.newUsersTrend': 'Новые пользователи',
